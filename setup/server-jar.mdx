---
title: "Download and Prepare a Minecraft Server JAR"
sidebarTitle: "Server JAR"
description: "Download Paper, Fabric, Forge, or Vanilla server JARs and prepare your server folder for use with ServerPilot on Windows."
---
...
When you browse to your server folder in ServerPilot, the `server:detect` IPC handler automatically scans for JAR files and identifies the type (Paper, Fabric, Forge, or Vanilla) based on the filename. The detected type is shown in the Server Modal as **Server type** and on the Dashboard — no manual configuration needed.
