---
title: "ServerPilot File Manager: Browse and Edit Server Files"
sidebarTitle: "File Manager"
description: "Browse your Minecraft server folder and edit YAML, JSON, properties, and config files using the Monaco Editor — the same engine that powers VS Code."
---
