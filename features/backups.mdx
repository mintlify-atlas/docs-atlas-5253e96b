---
title: "Create and Restore Minecraft World Backups"
sidebarTitle: "Backups"
description: "ServerPilot backs up your entire Minecraft server world to a ZIP archive with one click and lets you restore any previous backup instantly."
---
...
1. Validates that the `backupPath` is inside the server's `backups/` subfirectory using a strict `path.dirname` check — no other paths can be extracted
