---
title: "Integrated Console for Live Minecraft Server Logs"
sidebarTitle: "Console"
description: "ServerPilot's built-in console streams live Minecraft server output with color-coded log levels and lets you send commands directly to the running server process."
---
