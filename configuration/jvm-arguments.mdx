...
description: "Configure extra JVM flags for your Minecraft server in ServerPilot: GC tuning, sanitized arguments, and safe argument patterns explained."
---
...
Before inserting your `jvmArgs` into the command, ServerPilot scans each token and **removes** any argument that conflicts with fields it already manages. A warning message listing all removed arguments is printed to the server console so you always know what was stripped.
