---
title: "Global App Settings in ServerPilot"
sidebarTitle: "Settings"
description: "Configure ServerPilot's global defaults: Java path, RAM allocation, Playit.gg executable, auto-start, auto-restart, and UI theme."
---
...
Settings are sent to the main process over the `settings:update` IPC channel, which accepts a **partial** settings object and deep-merges it with the current saved state. Only the fields you include in the payload are updated — all other fields retain their existing values.
