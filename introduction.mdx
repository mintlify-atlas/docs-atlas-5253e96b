...
description: "ServerPilot is a Windows desktop app for local Minecraft servers. Manage start/stop, monitor performance, track players, and share with friends via Playit.gg."
---
