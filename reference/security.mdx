---
title: "ServerPilot Security Model: Sandbox and IPC Design"
sidebarTitle: "Security"
description: "ServerPilot's security model: Electron sandbox, restricted IPC bridge, filesystem path validation, protected Windows directories, and no-admin operation."
---
...
|---|---|---|
| `preload` | path to `preload.js` | Injects the IPC bridge script into the renderer before any page code runs, in an isolated context. |
